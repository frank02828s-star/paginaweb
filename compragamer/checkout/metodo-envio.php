...
<head>
    ...
    <title>CPU STORE VZLA - Método de envío</title>
    ...
    <main>
        <div class="container checkout-page">
            ...
            <div class="checkout-top-actions">
                <a class="btn btn-secondary checkout-back-btn" href="/carrito/">
...
<?php include __DIR__ . '/../partials/login-modal.php'; ?>
    ...
    <script>
      window.guardCheckoutStep && window.guardCheckoutStep('shipping', '/carrito/');
    </script>

    <!-- Pickup modal + shipping method logic -->
    <script src="/js/checkout/shipping-pickup.js"></script>
    <script src="/js/checkout/shipping-method.js"></script>
