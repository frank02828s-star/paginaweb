...
?>
    ...
    <header class="header">
        <div class="header-container">
            ...
            <div class="header-actions">
                ...
                <button class="cart-btn" id="cartBtn" onclick="window.location.href='/compragamer/carrito/'">
    ...
    <nav class="main-nav">
        <div class="nav-container">
            <a href="/compragamer/productos/" class="nav-link">Productos</a>
            <a href="/compragamer/productos/?cate=notebooks" class="nav-link">Notebooks</a>
            <a href="/compragamer/armatupc/" class="nav-link">Armá tu PC</a>
            <a href="/compragamer/ayuda/" class="nav-link">Ayuda</a>
        </div>
    </nav>
